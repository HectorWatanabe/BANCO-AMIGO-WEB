        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                <li class="dropdown">
                    ...
                    Cliente {{Auth::user()->name}} <b class="caret"></b></a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        <a href="{{(url('/home'))}}"><i class="fa fa-fw fa-desktop"></i> Bienvenido</a>
                    </li>
                    <li>
                        <a href="{{url('/accounts')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Cuentas</a>
                    </li>
                    <li>
                        <a href="{{url('/purses')}}"><i class="glyphicon glyphicon-credit-card"></i> Billetera</a>
                    </li>                    
                </ul>
            </div>
            <!-- /.navbar-collapse -->
